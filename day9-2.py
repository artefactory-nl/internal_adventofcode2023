def find_previous_value_in_sequence(line):
    ...
    def recursive_search(numbers):
        ...
        return numbers[0] - recursive_search(differences_in_paired_numbers)
...
answer = sum(find_previous_value_in_sequence(line) for line in input_lines)
print(answer)